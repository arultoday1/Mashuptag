...
<style type="text/css">
 body
        {
            background-image: url("images/sai1.jpg");
      ...
      <ul class="nav navbar-nav">
        ...
        <li><a href="fileupload.jsp">FILE UPLOAD</a></li>                
          ...
          <ul class="dropdown-menu">
            <li class="active"><a href="business.jsp">Business</a></li>
            <li><a href="digit.jsp">Digit IT</a></li>            
            <li><a href="dataquest.jsp">DataQuest</a></li>            
          </ul>
        </li>
...
PreparedStatement ps=con.prepareStatement("SELECT * FROM `power`.author1 a");
...
<%-- <td><%=filesize%></td>  --%>
 ...
 <td><a href="Download?file=<%=filename%>"><button><span class="glyphicon glyphicon-download"></span></button></a></td>
